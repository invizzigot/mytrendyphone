...
<template>
  ...
  <div class="flex flex-col items-center py-1 max-h-[620px] w-full md:max-h-max overscroll-contain  md:py-5 md:overscroll-y-auto">
    <div class="flex justify-evenly w-[345px]  md:w-[500px] h-[50px] mb-0 md:mb-2">
      <div class="w-[18%]">
    ...
    <div class="relative flex flex-col lg:flex-row items-center">
      <div
        class="relative flex flex-col items-center bg-slate-100/50 w-[330px] h-[580px] rounded-3xl shadow-xl ring-1 ring-slate-900/5"
      >
        <div
          class="absolute flex flex-col items-center overflow-hidden justify-center ring-1 ring-slate-900/5 w-[345px] h-[595px] rounded-3xl ml-[0px] mt-[-7px] bg-fit bg-bottom bg-no-repeat"
        >
          <div
          ...
          >
            <div v-motion-pop class="relative w-[360px] h-[550px]">
            ...
            <div class="relative w-[360px]  h-[550px]">
              ...
              >
                ...
                <div
                  ...
                  v-motion-slide-top
                  :class="[
                    'relative transition-all bg-slate-700 w-[100px] ml-10 pt-1 h-[50px] rounded-t-xl font-inter my-5 text-base whitespace-nowrap font-medium text-center leading-7 text-slate-100 border-l-2 border-r-2 border-t-2 border-slate-900/5 shadow-xl',
                ...
                <div
                  ...
                  :class="[
                    'relative transition-all bg-slate-700 w-[100px] ml-4 pt-1 h-[50px] rounded-t-xl font-inter my-5 text-base whitespace-nowrap font-medium text-center leading-7 text-slate-100 ring-1 ring-slate-900/5 border-l-2 border-r-2 border-t-2 border-slate-900/5 shadow-xl',
                    ...
                    <div class="flex flex-col items-start m-2">
                      ...
                      >
                        ...
                        >
                          <p
                            @click="addButton"
                            class="px-[4px] pt-[1px] pb-[4px] animate-pulse text-center text-3xl font-inter font-extrabold leading-none tracking-tight text-slate-100"
                          >
                            +
                          </p>
                        </div>
            ...
            <div class="relative w-[360px]  h-[550px]">
              ...
              <div class="flex flex-col ml- mt-2 items-left">
                ...
                <h1
                  class="invisible md:visible font-inter font-extrabold leading-none tracking-tight text-slate-900 text-3xl md:text-5xl sm:leading-[3.5rem]"
                >
                ...
                <p
                  v-else="
                    ...
                    casesTypes[selectedCaseType].price
                  "
                  class="font-inter w-[250px] pl-16 pr-10 m-5 text-xs whitespace-wrap font-medium text-center leading-5 text-slate-700"
                >
                  {{ dictionary.alert_box_stepper }}
                </p>
