...
<template>
  ...
  <div class="flex flex-col items-center py-1 max-h-[620px] md:max-h-max overscroll-contain  md:py-5 md:overscroll-y-auto">
    <div class="flex justify-evenly w-[345px]  md:w-[500px] h-[85px] mb-2">
      <div class="w-[18%]">
              ...
              <div class="flex flex-col ml- mt-2 items-left">
                ...
                <p
                  v-else="
                    ...
                    casesTypes[selectedCaseType].price
                  "
                  class="font-inter w-[250px] pl-14 pr-10 m-5 text-xs whitespace-wrap font-medium text-center leading-5 text-slate-700"
                >
                  {{ dictionary.alert_box_stepper }}
                </p>
