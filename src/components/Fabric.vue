...
<template>
  ...
  <div class="flex flex-col items-center py-1 max-h-[620px] md:max-h-max overscroll-contain  md:py-5 md:overscroll-y-auto">
    ...
    <div class="relative flex flex-col lg:flex-row items-center">
      <div
        class="relative flex flex-col items-center bg-slate-100/50 w-[345px] h-[580px] rounded-3xl shadow-xl ring-1 ring-slate-900/5"
      >
        <div
          class="absolute flex flex-col items-center overflow-hidden justify-center ring-1 ring-slate-900/5 w-[330px] h-[595px] rounded-3xl ml-[0px] mt-[-7px] bg-fit bg-bottom bg-no-repeat"
        >
          <div
